...
const aestheticProcedures = [
  { title: "Chemical Peeling", details: "Removes dead skin layers to reveal fresh, glowing skin while reducing pigmentation and acne marks." },
  { title: "HiFrecatator Removal of Moles & Warts", details: "Safe and effective mole, wart, and skin tag removal using advanced high-frequency cautery technology." },
  { title: "Laser Hair Reduction", details: "Permanent hair reduction with pain-free diode laser technology suitable for all skin types." },
  { title: "Microdermabrasion", details: "Exfoliates dead cells, smoothens texture, and rejuvenates dull skin for a youthful glow." },
  { title: "Laser Resurfacing", details: "Reduces scars, wrinkles, and uneven texture using precision laser skin resurfacing." },
  { title: "Tattoo Removal", details: "Advanced Q-switched laser removes unwanted tattoos safely and effectively over few sessions." },
  { title: "Acne Scar Revision", details: "Combination of laser and microneedling treatments to smoothen acne scars and refine skin texture." },
  { title: "Scar Treatments", details: "Targeted scar reduction treatments to flatten, fade, and smooth scars caused by injury or surgery." },
  { title: "Laser Treatment for Vitiligo", details: "Excimer laser therapy stimulates melanocytes for repigmentation in vitiligo patches." },
  { title: "PRP / GFC for Hair & Skin", details: "Platelet-rich plasma and GFC stimulate collagen and hair growth naturally for radiant skin and thicker hair." },
  { title: "Collagen Augmentation Therapy", details: "Non-surgical treatment that restores skin elasticity and firmness through collagen boosters." },
  { title: "Skin Tightening & Stretch Mark Reduction", details: "Radiofrequency and laser technologies tighten skin and reduce post-pregnancy stretch marks." },
  { title: "Torn Ear Lobe Repair", details: "Quick, safe cosmetic suturing procedure to correct torn or split earlobes." },
  { title: "Cryotherapy", details: "Freezing treatment used for removal of warts, skin tags, and other benign lesions." },
  { title: "Medi Facial & Carbon Peel", details: "Deep-cleansing facials and carbon peels for instant brightness, glow, and rejuvenation." },
];
