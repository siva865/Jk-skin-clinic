...
export default function Footer() {
  return (
    <footer className="bg-[#F6D3A6] text-[#622619] py-10">
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="flex items-center gap-6 text-2xl">
          ...
          <a
            ...
            className="hover:text-[#8F501B] transition-transform transform hover:scale-125"
          >
            <FaGoogle />
          </a>
      ...
      {/* Divider Line */}
      <div className="border-t border-[#8F501B] my-6 opacity-50"></div>

      {/* Bottom Text */}
      <div className="text-center text-sm md:text-base">
        © {new Date().getFullYear()} <span className="font-semibold">JK Skin Clinic</span>. All Rights Reserved.
      </div>
    </footer>
  );
}
